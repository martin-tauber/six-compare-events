...
def main() -> None:
    ...
    write_csv(
        output_dir / "filtered_truesight_events.csv",
        truesight_to_bhom["filtered"],
        [
            "truesight_event_id",
            "object_class",
            "instance_name",
...
def build_dataset_info(
    ...
    *,
    ...
    if exception_path is not None:
        exception_info = fingerprint_file(exception_path)
    ...
    *,
    ...
    if candidate_event_key and candidate_event_key in row:
        ...
        return {
            ...
            "instance_name": primary_event.get("instance_name") or primary_event.get("object_name", ""),
